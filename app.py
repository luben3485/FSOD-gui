...
def support_image():
    ...
    cnt_result_img_path = os.path.join(output_path_folder, 'result' + str(cnt_shot) + '.jpg')
    if pre_shot != 0:
        pre_result_img_path = os.path.join(output_path_folder, 'result' + str(pre_shot) + '.jpg')
    else:
        pre_result_img_path = ''
    ...
    return render_template("index.html",  current_img_path = cnt_result_img_path, current_n_shot = cnt_shot, current_support_path_list =  cnt_support_im_paths ,
                           previous_img_path= pre_result_img_path, previous_n_shot= pre_shot,previous_support_path_list= pre_support_im_paths)
...
def query_image():
    ...
    return render_template("index.html", current_img_path = 'static/img/data/query.jpg')
